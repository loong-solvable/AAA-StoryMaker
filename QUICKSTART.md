...
📌 三阶段构建流程:
   1️⃣ 角色过滤 - 识别所有角色并评估重要性
   2️⃣ 世界设定 - 提取物理法则、社会规则、地点
   3️⃣ 角色档案 - 为每个角色创建详细档案

======================================================================

[2024-11-26] [Architect] [INFO] 🏗️  初始化架构师Agent...
[2024-11-26] [LLMFactory] [INFO] 🤖 正在创建LLM实例...
[2024-11-26] [Architect] [INFO] ✅ 架构师Agent初始化完成
[2024-11-26] [Architect] [INFO] 📍 阶段1：角色过滤（角色普查）
[2024-11-26] [Architect] [INFO] ✅ 角色普查完成，发现 15 个角色
[2024-11-26] [Architect] [INFO] 📍 阶段2：提取世界观设定
[2024-11-26] [Architect] [INFO] ✅ 世界观设定提取完成
[2024-11-26] [Architect] [INFO] 📍 阶段3：创建角色详细档案
...
[2024-11-26] [Architect] [INFO] ✅ 世界数据已保存
...
1. **查看代码实现**
   - 阅读 `agents/offline/architect.py` 了解三阶段处理流程
   - 查看 `prompts/offline/` 目录了解三个架构师的Prompt

2. **修改Prompt**
   - 编辑 `世界观架构师.txt` 优化世界设定提取
   - 编辑 `角色制作架构师` 优化角色档案生成
   - 编辑 `角色过滤架构师.txt` 调整角色重要性评估
