...
OS 是游戏运行阶段的核心组件，其**最重要的职责**是将 Plot 产出的剧本拆分并分发给各个演员：
...
│   {                                                          │
│     "scene": "咖啡馆内，气氛紧张",                              │
│     "characters": ["linchen", "suqingyu"],                   │
│     "actions": [                                              │
│       {char: "linchen", action: "站起身", dialogue: ".."}     │
│       {char: "suqingyu", action: "皱眉", dialogue: ".."}      │
│     ]                                                        │
│   }                                                          │
│         │                                                    │
│         ▼                                                    │
...
| 功能 | 说明 |
|------|------|
| **剧本拆分** | 解析 Plot 产出的完整剧本，识别参与角色和各自戏份 |
| **消息分发** | 为每个 NPC Agent 创建专属小剧本并分发 |
| **状态管理** | 维护游戏全局状态、世界上下文、游戏历史 |
