"""
维维克医生 (npc_004) - 角色专属Agent
自动生成于 2025-12-02 10:54:14

提示词文件: prompts/online/npc_prompt/npc_004_维维克医生_prompt.txt
"""
import json
...
class Npc004Agent:
    ...
    提示词: 从 prompts/online/npc_prompt/npc_004_维维克医生_prompt.txt 读取
    角色数据已预填充到提示词文件中，运行时只需填充剧本相关变量
    """
    
    CHARACTER_ID = "npc_004"
    CHARACTER_NAME = "维维克医生"
    PROMPT_FILE = "npc_prompt/npc_004_维维克医生_prompt.txt"  # 专属提示词文件
