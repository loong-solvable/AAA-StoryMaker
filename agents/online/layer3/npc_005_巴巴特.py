"""
巴巴特 (npc_005) - 角色专属Agent
自动生成于 2025-12-02 10:54:16

提示词文件: prompts/online/npc_prompt/npc_005_巴巴特_prompt.txt
"""
import json
...
class Npc005Agent:
    ...
    提示词: 从 prompts/online/npc_prompt/npc_005_巴巴特_prompt.txt 读取
    角色数据已预填充到提示词文件中，运行时只需填充剧本相关变量
    """
    
    CHARACTER_ID = "npc_005"
    CHARACTER_NAME = "巴巴特"
    PROMPT_FILE = "npc_prompt/npc_005_巴巴特_prompt.txt"  # 专属提示词文件
