"""
洛洛加元帅 (npc_006) - 角色专属Agent
自动生成于 2025-12-02 10:54:10

提示词文件: prompts/online/npc_prompt/npc_006_洛洛加元帅_prompt.txt
"""
import json
...
class Npc006Agent:
    ...
    提示词: 从 prompts/online/npc_prompt/npc_006_洛洛加元帅_prompt.txt 读取
    角色数据已预填充到提示词文件中，运行时只需填充剧本相关变量
    """
    
    CHARACTER_ID = "npc_006"
    CHARACTER_NAME = "洛洛加元帅"
    PROMPT_FILE = "npc_prompt/npc_006_洛洛加元帅_prompt.txt"  # 专属提示词文件
